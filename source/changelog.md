...
- Changes to the **patch** version number are relatively minor bug fixes and we hope they do not change behavior
...
**This changelog is now deprecated and won't be updated. The [GitHub Releases page for PsychoPy](https://github.com/psychopy/psychopy/releases) provides a full set of release notes for each release instead.**

PsychoPy 2024.2
-----------------

Although there are many changes and therefore potential for some slight changes in behaviour we have focussed more this release on just making existing functionality smoother rather than adding new big features.
...
* Added "force nonslip" parameter to Routine Settings so that you can now use non-slip timing for a Routine using a variable by @TEParsons in [#6603](https://github.com/psychopy/psychopy/issues/6603) 
* Fix opacity not applying properly to border colors by @TEParsons in [#6704](https://github.com/psychopy/psychopy/issues/6704)
* User can set the online end message from Builder rather than relying on JS default by @TEParsons in [#6258](https://github.com/psychopy/psychopy/issues/6258)
* Performance improvements for MovieStim (parituclarly noticeable for larger videos) by @aforren1 in [#6449](https://github.com/psychopy/psychopy/issues/6449)
* Added functions to MicrophoneDevice to continuously monitor volume by @TEParsons in [#6444](https://github.com/psychopy/psychopy/issues/6444)
* Added function to check whether a speaker is working by @TEParsons in [#6446](https://github.com/psychopy/psychopy/issues/6446)
* Builder can now set logging level for app console, independently of log file by @TEParsons in [#6510](https://github.com/psychopy/psychopy/issues/6510)
* Added Keyboard.getState() to get current state of a key by @TEParsons in [#6537](https://github.com/psychopy/psychopy/issues/6537)
* Added text-to-speech synthesis by @mdcutone in [#6588](https://github.com/psychopy/psychopy/issues/6588)
...
* Eyetracking: can now save dwell times from ROI component by @RebeccaHirst in [#6500](https://github.com/psychopy/psychopy/issues/6500)
* If storing all valid mouse clicks, still show invalid clicks explicitly in the list as `None` (or `Null` online) e.g. [None, "foil", "target"] for 3 clicks ending in target by @TEParsons in [#6516](https://github.com/psychopy/psychopy/issues/6516) [#6548](https://github.com/psychopy/psychopy/issues/6548)
* Some loops/form/counterbalance were not fetching the correct xlsx templates by @TEParsons in [#6514](https://github.com/psychopy/psychopy/issues/6514)
* Implement orientation parameter for TextBox2 by @TEParsons in [#6513](https://github.com/psychopy/psychopy/issues/6513)
* New changelog dialog on app start by @TEParsons in [#6445](https://github.com/psychopy/psychopy/issues/6445)
* Improved error message for iohub connection error (issue [#1226](https://github.com/psychopy/psychopy/issues/1226)) by @MarkellaEgglezou in [#6354](https://github.com/psychopy/psychopy/issues/6354)
* Visual stimuli now `draggable` attribute accessible from Builder by @TEParsons in [#6337](https://github.com/psychopy/psychopy/issues/6337)
* Improved TrialHandler2 for more flexible adding/cancelling and retrieving info about trials @TEParsons in [#6425](https://github.com/psychopy/psychopy/issues/6425) [#6408](https://github.com/psychopy/psychopy/issues/6408) [#6590](https://github.com/psychopy/psychopy/issues/6590)
* Using PhotoDiodes Components in experiments (e.g. in BBTK T-pad) [#6432](https://github.com/psychopy/psychopy/issues/6432) [#6442](https://github.com/psychopy/psychopy/issues/6442)
* Provide PsychoPy experiment filename to the ioHub server by @mh105 in [#6555](https://github.com/psychopy/psychopy/issues/6555)
* Allow experiment to pause on the current frame by @TEParsons in [#6584](https://github.com/psychopy/psychopy/issues/6584)
* Allow plugins to be uninstalled via the manager by @mdcutone in [#6587](https://github.com/psychopy/psychopy/issues/6587)
* Store/update Routine parameters live in an object, rather than hardcoding them to the experiment file by @TEParsons in [#6597](https://github.com/psychopy/psychopy/issues/6597)
* Make save speech onset/offset only available to supporting transcribers by @kimDundas in [#6672](https://github.com/psychopy/psychopy/issues/6672)

**🐛 Bug Fixes:**

* Fixed error sampling microphone volume even when buffer is full by @TEParsons in [#6488](https://github.com/psychopy/psychopy/issues/6488)
* Fixed plugins page sometimes failed to load cached plugins file due to encoding error by @peircej in [#6428](https://github.com/psychopy/psychopy/issues/6428)
* Fixed the launch of PsychoPy App on conda envs without pythonw by @mh105 in [#6436](https://github.com/psychopy/psychopy/issues/6436)
* Allowed Static Component to update params by @TEParsons in [#6462](https://github.com/psychopy/psychopy/issues/6462)
* Fixed TextStim letter height wasn't settable each frame/Routine in JS by @TEParsons in [#6511](https://github.com/psychopy/psychopy/issues/6511)
* Fixed check for pythonw executable on macOS in psychopyApp.py by @mh105 in [#6521](https://github.com/psychopy/psychopy/issues/6521)
* Fixed .js file not being found when using "Use version" (removed _legacy from suffix) by @RebeccaHirst in [#6515](https://github.com/psychopy/psychopy/issues/6515)
* Hide dollar sign on start/stop controls when one is hidden by @TEParsons in [#6528](https://github.com/psychopy/psychopy/issues/6528)
* Removed unused %s string format in MenuFrame to avoid unrecognized accel key by @mh105 in [#6523](https://github.com/psychopy/psychopy/issues/6523)
* Remove incorrect code on removing eyetracker generated by builder by @mh105 in [#6526](https://github.com/psychopy/psychopy/issues/6526)
* Fixed import backend_pysound after module name change by @mh105 in [#6524](https://github.com/psychopy/psychopy/issues/6524)
* Caught AttributeError for sound.getDevices() when opening PreferenceDlg by @mh105 in [#6522](https://github.com/psychopy/psychopy/issues/6522)
* Unregister event monitors during iohub calibration by @mh105 in [#6466](https://github.com/psychopy/psychopy/issues/6466)
* Fixed plugin discovery algorithm not finding user package entry points correctly by @mdcutone in [#6539](https://github.com/psychopy/psychopy/issues/6539)
* Allow enough time for all ioHub device._close() to finish by @mh105 in [#6540](https://github.com/psychopy/psychopy/issues/6540)
* Use default speaker device if index is default by @mh105 in [#6538](https://github.com/psychopy/psychopy/issues/6538)
* Fixed eyetracker record stop/start by @TEParsons in [#6545](https://github.com/psychopy/psychopy/issues/6545)
* Fixed duplicate dependency install on MacOS and package installation in virtual environments by @mdcutone in [#6529](https://github.com/psychopy/psychopy/issues/6529)
* Fixed size and pos of Line by @TEParsons in [#6543](https://github.com/psychopy/psychopy/issues/6543) and @mh105 in  [#6525](https://github.com/psychopy/psychopy/issues/6525)
* Fied bug setting Sound in static period online by @TEParsons in [#6546](https://github.com/psychopy/psychopy/issues/6546)
* Fixed ioHub finding eyetracker configuration files by @TEParsons in [#6547](https://github.com/psychopy/psychopy/issues/6547)
* Fixed the issue that speaker index could jump over integers by @mh105 in [#6559](https://github.com/psychopy/psychopy/issues/6559)
* Fixed crash when mono is specified if the microphone device expects stereo as default by @mdcutone in [#6564](https://github.com/psychopy/psychopy/issues/6564)
* Fixed csv conditions file loading by @TEParsons in [#6552](https://github.com/psychopy/psychopy/issues/6552)
* Get correct speech onset/offset times and write them to data file by @mdcutone in [#6566](https://github.com/psychopy/psychopy/issues/6566)
* Fixed dict keys for setting sample filter levels by @mh105 in [#6554](https://github.com/psychopy/psychopy/issues/6554)
* Add default duration to eyetracker record component by @RebeccaHirst in [#6599](https://github.com/psychopy/psychopy/issues/6599)
* Remove second whisper option from mic transcriber backend drop down by @RebeccaHirst in [#6604](https://github.com/psychopy/psychopy/issues/6604)
* Fixed remove the use of currentlyRecording in EyetrackerControl by @mh105 in [#6567](https://github.com/psychopy/psychopy/issues/6567)
* Fixed syntax for mic max recording parameter by @RebeccaHirst in [#6598](https://github.com/psychopy/psychopy/issues/6598)
* Decouple setting status from triggering playback/clock resets/etc. by @TEParsons in [#6562](https://github.com/psychopy/psychopy/issues/6562)
* Fixed starting and stopping times for EyetrackerRecordComponent by @mh105 in [#6607](https://github.com/psychopy/psychopy/issues/6607)
* Don't change self.param in getStartAndDuration of et component by @mh105 in [#6615](https://github.com/psychopy/psychopy/issues/6615)
* Typo in JS boilerplate (True rather than true) by @wakecarter in [#6625](https://github.com/psychopy/psychopy/issues/6625)
* Builder: Ensure frame rate is stored. by @aforren1 in [#6619](https://github.com/psychopy/psychopy/issues/6619)
* Allow Sound to stop on a condition rather than just time by @TEParsons in [#6631](https://github.com/psychopy/psychopy/issues/6631)
* Fix `obj.contains is not a function` error in JS by @TEParsons in [#6635](https://github.com/psychopy/psychopy/issues/6635)
* Enable correct behavior of entry-points to load eyetrackers by @mh105 in [#6610](https://github.com/psychopy/psychopy/issues/6610)
* Movie component Volume inputType should be single instead of float by @mh105 in [#6643](https://github.com/psychopy/psychopy/issues/6643)
* Use inspect.getfile to check path of plugin entry points by @mh105 in [#6660](https://github.com/psychopy/psychopy/issues/6660)
* UI wasn't fully refreshing after changing theme by @TEParsons in [#6673](https://github.com/psychopy/psychopy/issues/6673)
* Coder GUI fixes by @aforren1 in [#6678](https://github.com/psychopy/psychopy/issues/6678)
* Allow keyboard allowedKeys to be set as an int by @TEParsons in [#6676](https://github.com/psychopy/psychopy/issues/6676)
* Enable mouse clickable from variable when running online by @RebeccaHirst in [#6668](https://github.com/psychopy/psychopy/issues/6668)
* Fixed crash when `clearEvents(device_label=None)` by @mdcutone in [#6669](https://github.com/psychopy/psychopy/issues/6669)
* Fix JS translation of `.pop()` when there's no index by @TEParsons in [#6651](https://github.com/psychopy/psychopy/issues/6651)
* Allow polygon outline opacity to be persistent across frames by @mdcutone in [#6657](https://github.com/psychopy/psychopy/issues/6657)
* Sound Component code was using the wrong set function name in JS by @TEParsons in [#6649](https://github.com/psychopy/psychopy/issues/6649)
* Fixed files being marked as modified as soon as opened by @TEParsons in [#6679](https://github.com/psychopy/psychopy/issues/6679)
* Re-add distro as a runtime dependency for linux & remove deprecated function. by @aforren1 in [#6686](https://github.com/psychopy/psychopy/issues/6686)
* Save mouse.corr for online studies by @RebeccaHirst in [#6701](https://github.com/psychopy/psychopy/issues/6701)
* Creating project from ribbon raised error by @TEParsons in [#6706](https://github.com/psychopy/psychopy/issues/6706)
* Plugin Components weren't recognised if experiment loaded with app by @TEParsons in [#6707](https://github.com/psychopy/psychopy/issues/6707)
* Original types for "UnknownPluginComponent"s were being lost after loading and saving again by @TEParsons in [#6708](https://github.com/psychopy/psychopy/issues/6708)
* Start/Stop controls had lost their tooltip by @TEParsons in [#6711](https://github.com/psychopy/psychopy/issues/6711)
* Update flow button style when switching theme by @TEParsons in [#6712](https://github.com/psychopy/psychopy/issues/6712)
* Conditions file wasn't updated when chosen from file browser for multistair loops by @TEParsons in [#6714](https://github.com/psychopy/psychopy/issues/6714)
* Save to the color cache when rendering. by @aforren1 in [#6720](https://github.com/psychopy/psychopy/issues/6720)
* BF/RF: Code to load Builder-relevant entry points was broken and obsolete by @TEParsons in [#6717](https://github.com/psychopy/psychopy/issues/6717)
* maxDurationReached in Routine Settings False should be false online by @wakecarter in [#6724](https://github.com/psychopy/psychopy/issues/6724)
* fix trial data writing when there are multiple key presses including None by @mh105 in [#6718](https://github.com/psychopy/psychopy/issues/6718)
* Fixed units for mouse gaze calibration targets (pix -> height) by @KirstenWilliams in [#6443](https://github.com/psychopy/psychopy/issues/6443)
* Standardise `tDown` attribute between ioHub and ptb Keyboard backends (follow ioHub behaviour) by @TEParsons in [#6417](https://github.com/psychopy/psychopy/issues/6417)
* Improved audio resampling method by @mdcutone in [#6605](https://github.com/psychopy/psychopy/issues/6605)
* Change iohub port to avoid conflicts with Whisper transcription by @mdcutone in [#6661](https://github.com/psychopy/psychopy/issues/6661)
* Fixed 'best match' mic settings not being used to init recording buffer by @mdcutone in [#6670](https://github.com/psychopy/psychopy/issues/6670)
* Prompt user to reconsider if they try to close plugin window mid-install by @TEParsons in [#6705](https://github.com/psychopy/psychopy/issues/6705)

## 📓 Docs & Demos
* Create hdf5_2_csv by @KirstenWilliams in [#6508](https://github.com/psychopy/psychopy/issues/6508)
* make a note that writeRoutineEndCode does not save onset/offset times by @mh105 in [#6571](https://github.com/psychopy/psychopy/issues/6571)
* Add demo for Button Box Component by @TEParsons in [#6716](https://github.com/psychopy/psychopy/issues/6716)

## Translations
* Arabic: new by @Ahmad-Abudoush @Ahmad-Ramy in [#6634](https://github.com/psychopy/psychopy/issues/6634) [#6638](https://github.com/psychopy/psychopy/issues/6638) [#6636](https://github.com/psychopy/psychopy/issues/6636) [#6674](https://github.com/psychopy/psychopy/issues/6674) and with DeepL by @peircej in [#6641](https://github.com/psychopy/psychopy/issues/6641)
* Portugese: new by @joana-quarenta in [#6662](https://github.com/psychopy/psychopy/issues/6662) [#6665](https://github.com/psychopy/psychopy/issues/6665) [#6690](https://github.com/psychopy/psychopy/issues/6690)
* Japanese: updates by @hsogo in [#6654](https://github.com/psychopy/psychopy/issues/6654)
* Spanish: es-co, es_es and es_us now completed by @carosamu in [#6541](https://github.com/psychopy/psychopy/issues/6541) [#6577](https://github.com/psychopy/psychopy/issues/6577)

## New Contributors
* @MarkellaEgglezou made their first contribution in [#6354](https://github.com/psychopy/psychopy/issues/6354)
* @xjlc made their first contribution in [#6570](https://github.com/psychopy/psychopy/issues/6570)
* @EyeLogicSolutions made their first contribution in [#6586](https://github.com/psychopy/psychopy/issues/6586)
* @Ahmad-Ramy made their first contribution in [#6636](https://github.com/psychopy/psychopy/issues/6636)
* @mabuhayeh made their first contribution in [#6638](https://github.com/psychopy/psychopy/issues/6638)
* @joana-quarenta made their first contribution in [#6662](https://github.com/psychopy/psychopy/issues/6662)
...
* Updated translations for Spanish variants by @carosamu in [#6763](https://github.com/psychopy/psychopy/issues/6763) [#6737](https://github.com/psychopy/psychopy/issues/6737)
...
* Fix ribbon buttons showing label on Mac by @TEParsons in [#6767](https://github.com/psychopy/psychopy/issues/6767)
* Builder files were marked as modified as soon as opened by @TEParsons in [#6778](https://github.com/psychopy/psychopy/issues/6778)
* Builder getting start/stop times when using non-slip timing by @mh105 in [#6739](https://github.com/psychopy/psychopy/issues/6739)
* Restore backwards-compatability to `psychopy.gui.dlg` by @TEParsons in [#6792](https://github.com/psychopy/psychopy/issues/6792)
* Routines were still writing their end experiment code in JS even when removed from the flow by @TEParsons in [#6780](https://github.com/psychopy/psychopy/issues/6780)
* Fix whisper transcriber sometimes being initialised twice (and breaking as a result) by @TEParsons in [#6796](https://github.com/psychopy/psychopy/issues/6796)
* DlgFromDict was erroneously adding keys when given "order" or "fixed" by @TEParsons in [#6818](https://github.com/psychopy/psychopy/issues/6818)
* Make output of Dlg.show backwards compatible with older versions by @TEParsons in [#6809](https://github.com/psychopy/psychopy/issues/6809) [#6792](https://github.com/psychopy/psychopy/issues/6792)
* pyglet controls of macOS NSWindow with multiple screens  by @mh105 in [#6799](https://github.com/psychopy/psychopy/issues/6799)
* Fixed detection of installed packages in standalone app for py3.10 by @mh105 in [#6771](https://github.com/psychopy/psychopy/issues/6771)
* Smoother output from background jobs to stdout by @mh105 in [#6833](https://github.com/psychopy/psychopy/issues/6833)
...
* Recreate .js file on run when piloting in JS by @TEParsons in [#6920](https://github.com/psychopy/psychopy/issues/6920)
* App failing to start on MacOS if all windows closed on last app close by @peircej in [#6926](https://github.com/psychopy/psychopy/issues/6926)
* Fix nonslip timing issue in Builder-generated PsychoJS code by @TEParsons in [#6921](https://github.com/psychopy/psychopy/issues/6921)
...
* ioHub process was not cleanly exiting and then causing a crash on subsequent attempts to run @mh105 and @mdcutone in [#6949](https://github.com/psychopy/psychopy/issues/6949) and [#6938](https://github.com/psychopy/psychopy/issues/6938)
* Sending experiment to Runner was sometimes (incorrectly) toggling pilot/run mode by @TEParsons in [#6945](https://github.com/psychopy/psychopy/issues/6945)
* Arabic Translation_update by @Ahmad-Abudoush in [#6959](https://github.com/psychopy/psychopy/issues/6959)
...
* Added plugin support for standalone plugins by @mdcutone in [#5866](https://github.com/psychopy/psychopy/issues/5866)
...
* Allow speech-to-text engine configuration from Builder by @mdcutone in [#5905](https://github.com/psychopy/psychopy/issues/5905)
* Replace toolbars with a "Ribbon" by @TEParsons in [#5920](https://github.com/psychopy/psychopy/issues/5920)
* Method for processing device info on Windows by @TEParsons in [#5940](https://github.com/psychopy/psychopy/issues/5940)
* Added tools for creating and managing hardware interfaces by @mdcutone in [#5950](https://github.com/psychopy/psychopy/issues/5950)
* Allow expInfo fields to be ordered, required, hidden and deprioritised using a new name syntax by @TEParsons in [#5949](https://github.com/psychopy/psychopy/issues/5949)
* Added Counterbalance Routine (and Python implementation of Shelf) by @TEParsons in [#5967](https://github.com/psychopy/psychopy/issues/5967)
* Add component for Button Box, with plugin-able backends by @TEParsons in [#6006](https://github.com/psychopy/psychopy/issues/6006)
* Option in Builder to skip/customise frame rate check by @TEParsons in [#6049](https://github.com/psychopy/psychopy/issues/6049)
* Option in Builder to specify globalClock format by @TEParsons in [#6048](https://github.com/psychopy/psychopy/issues/6048)
* Added method to Window to get value of specific pixels by @mdcutone in [#6054](https://github.com/psychopy/psychopy/issues/6054)
* Added piloting mode by @TEParsons in [#6066](https://github.com/psychopy/psychopy/issues/6066)
* Add param to enable "rush" mode by @TEParsons in [#6279](https://github.com/psychopy/psychopy/issues/6279)
* Speed up plugin dialog by @mdcutone in [#5796](https://github.com/psychopy/psychopy/issues/5796)
* Better handling when opening e.g. png files in Coder by @TEParsons in [#5788](https://github.com/psychopy/psychopy/issues/5788)
* Speed up app by using faster string tools for labels and methods by @TEParsons in [#5826](https://github.com/psychopy/psychopy/issues/5826)
* Improved plugin installation method by @mdcutone in [#5872](https://github.com/psychopy/psychopy/issues/5872)
* Allow prefs dialog menu to be resized by @TEParsons in [#5869](https://github.com/psychopy/psychopy/issues/5869)
* Add method to manually create a keypress, photodiode response, etc. by @TEParsons in [#6022](https://github.com/psychopy/psychopy/issues/6022)
* Add option to ignore keypresses outside of PsychoPy window by @TEParsons in [#6039](https://github.com/psychopy/psychopy/issues/6039)
* Allow Sound to specify a Speaker rather than using general system audio by @TEParsons in [#6079](https://github.com/psychopy/psychopy/issues/6079)
* Add method to wait for responses to SerialDevice by @TEParsons in [#6092](https://github.com/psychopy/psychopy/issues/6092)
* Include link to project in "Successful sync" message by @TEParsons in [#6171](https://github.com/psychopy/psychopy/issues/6171)
* Silence "Unrecognised Parameter" warnings if params came from a plugin by @TEParsons in [#6179](https://github.com/psychopy/psychopy/issues/6179)
* Speed up experiment loading by @TEParsons in [#6180](https://github.com/psychopy/psychopy/issues/6180)
* Catch fails in Packages dialog by @TEParsons in [#6193](https://github.com/psychopy/psychopy/issues/6193)
* Hide components/routines from future versions by @TEParsons in [#6200](https://github.com/psychopy/psychopy/issues/6200)
* More intuitive label on Pavlovia project info update button by @TEParsons in [#6217](https://github.com/psychopy/psychopy/issues/6217)
* Added menu item in Builder to reveal current folder by @TEParsons in [#6218](https://github.com/psychopy/psychopy/issues/6218)
* Install packages in editable mode via a pyproject.toml file by @TEParsons in [#6228](https://github.com/psychopy/psychopy/issues/6228)
* Improvements to Code component UI behaviour by @TEParsons in [#6265](https://github.com/psychopy/psychopy/issues/6265)
* Open news from menu by @peircej in [#6205](https://github.com/psychopy/psychopy/issues/6205)
* Make expInfo dialog always on top by @TEParsons in [#6301](https://github.com/psychopy/psychopy/issues/6301)

**Bug fixes:**

* Fix matrix questions Survey Routine by @TEParsons in [#5797](https://github.com/psychopy/psychopy/issues/5797)
* Fix crash which happened if wx wasn't installed by @peircej in [#5832](https://github.com/psychopy/psychopy/issues/5832)
* Make sure icons & labels in preferences dialog are always visible by @TEParsons in [#5868](https://github.com/psychopy/psychopy/issues/5868)
* Handle when Component has no start time in JS by @TEParsons in [#5864](https://github.com/psychopy/psychopy/issues/5864)
* Static component was preventing Movie from starting by @TEParsons in [#5928](https://github.com/psychopy/psychopy/issues/5928)
* Change default logging level to warning by @suelynnmah in [#5941](https://github.com/psychopy/psychopy/issues/5941)
* Let experiments run without git installed by @TEParsons in [#5939](https://github.com/psychopy/psychopy/issues/5939)
* Fix bug whereby Brush wouldn't pick up on mouse clicks by @TEParsons in [#6056](https://github.com/psychopy/psychopy/issues/6056)
* Fix inconsistent data outside trial loop by @monique2208 in [#6004](https://github.com/psychopy/psychopy/issues/6004)
* Fix shape setting on Polygon-derived components (e.g. ROI) by @TEParsons in [#5971](https://github.com/psychopy/psychopy/issues/5971)
* Remove darc toolbox demos (maintainer no longer supporting package) by @RebeccaHirst in [#6094](https://github.com/psychopy/psychopy/issues/6094)
* Fixed error when `audioLib` is `None` by @mdcutone in [#6103](https://github.com/psychopy/psychopy/issues/6103)
* Handle unconventional launch methods (e.g. launching from command line with unrecognised args) by @peircej in [#6118](https://github.com/psychopy/psychopy/issues/6118)
* Fixed error with resizing "sash" in Preferences dialogby @mdcutone in [#6146](https://github.com/psychopy/psychopy/issues/6146)
* If psychtoolbox can't detect devices, log warning rather than crashing by @TEParsons in [#6150](https://github.com/psychopy/psychopy/issues/6150)
* Fixed error when using Save in Coder when there is no file open by @nvanhaute in [#6158](https://github.com/psychopy/psychopy/issues/6158)
* Fixed "missing reference" error with setting Sound device by @mdcutone in [#6122](https://github.com/psychopy/psychopy/issues/6122)
* Fix _set function for NoiseStim to handle input length by @simonfei123 in [#6136](https://github.com/psychopy/psychopy/issues/6136)
* Draw expected duration from Routine Settings in Builder by @TEParsons in [#6190](https://github.com/psychopy/psychopy/issues/6190)
* Fix error when loading window whose size is negative by @mdcutone in [#6192](https://github.com/psychopy/psychopy/issues/6192)
* Stop Builder from assuming the current folder is .../psychopy/app whenever filename is "untitled.psyexp" by @TEParsons in [#6198](https://github.com/psychopy/psychopy/issues/6198)
* Catch error when package info is missing by @mdcutone in [#6202](https://github.com/psychopy/psychopy/issues/6202)
* Experiments weren't working online if experiment name differed from filename by @TEParsons in [#6221](https://github.com/psychopy/psychopy/issues/6221)
* Fixed iohub eyetracker calibration (keyboard was losing input) by @mdcutone in [#6226](https://github.com/psychopy/psychopy/issues/6226)
* Handle when Static component has no start time by @TEParsons in [#6248](https://github.com/psychopy/psychopy/issues/6248)
* Don't scroll to top after opening a Builder component category by @TEParsons in [#6251](https://github.com/psychopy/psychopy/issues/6251)
* Fixed Mouse.visible attribute not applying requested state by @mdcutone in [#6254](https://github.com/psychopy/psychopy/issues/6254)
* Fixed freeze when running eyetracker validation by @mdcutone in [#6264](https://github.com/psychopy/psychopy/issues/6264)
* Fix error when cancelling a commit by @TEParsons in [#6271](https://github.com/psychopy/psychopy/issues/6271)
* Special code for when Slider is "radio" was missed in JS code by @TEParsons in [#6272](https://github.com/psychopy/psychopy/issues/6272)
* Fix "iCCP profiles" error with classic icons by @TEParsons in [#6276](https://github.com/psychopy/psychopy/issues/6276)
* Fix wrong setter name in Textbox/TextStim JS code by @TEParsons in [#6277](https://github.com/psychopy/psychopy/issues/6277)
* New Pavlovia projects were being created empty until first commit by @TEParsons in [#6273](https://github.com/psychopy/psychopy/issues/6273)
* Fix UI inconsistencies on Ubuntu by @TEParsons in [#6242](https://github.com/psychopy/psychopy/issues/6242)
* Fix code for sound component stop values by @zuazo in [#6300](https://github.com/psychopy/psychopy/issues/6300)
* Fixed selecting audio device in builder and coder by @zuazo in [#6299](https://github.com/psychopy/psychopy/issues/6299)
* Fix bug where local PsychoJS server kept running after quitting by @TEParsons in [#6323](https://github.com/psychopy/psychopy/issues/6323)
...
* Continued translation into Simplified Chinese (and now Traditional Chinese) and beginnings of translations into Spanish, Hebrew: [#5891](https://github.com/psychopy/psychopy/issues/5891) [#5892](https://github.com/psychopy/psychopy/issues/5892) [#5893](https://github.com/psychopy/psychopy/issues/5893) [#5894](https://github.com/psychopy/psychopy/issues/5894) [#5895](https://github.com/psychopy/psychopy/issues/5895) [#5897](https://github.com/psychopy/psychopy/issues/5897) [#5904](https://github.com/psychopy/psychopy/issues/5904) [#5912](https://github.com/psychopy/psychopy/issues/5912) [#5915](https://github.com/psychopy/psychopy/issues/5915) [#5917](https://github.com/psychopy/psychopy/issues/5917) [#5923](https://github.com/psychopy/psychopy/issues/5923) [#5903](https://github.com/psychopy/psychopy/issues/5903) [#5932](https://github.com/psychopy/psychopy/issues/5932) [#5925](https://github.com/psychopy/psychopy/issues/5925)


### New contributors

* @mscheltienne made their first contribution in [#5889](https://github.com/psychopy/psychopy/issues/5889)
* @JensBoelte made their first contribution in [#5956](https://github.com/psychopy/psychopy/issues/5956)
* @d-scanzi made their first contribution in [#5952](https://github.com/psychopy/psychopy/issues/5952)
* @kshtjkumar made their first contribution in [#5955](https://github.com/psychopy/psychopy/issues/5955)
* @Solveig-Castelli made their first contribution in [#5961](https://github.com/psychopy/psychopy/issues/5961)
* @carosamu made their first contribution in [#5972](https://github.com/psychopy/psychopy/issues/5972)
* @monique2208 made their first contribution in [#6004](https://github.com/psychopy/psychopy/issues/6004)
* @afuetterer made their first contribution in [#6110](https://github.com/psychopy/psychopy/issues/6110)
* @bartuatabek made their first contribution in [#5942](https://github.com/psychopy/psychopy/issues/5942)
* @FS94 made their first contribution in [#6121](https://github.com/psychopy/psychopy/issues/6121)
* @simonfei123 made their first contribution in [#6136](https://github.com/psychopy/psychopy/issues/6136)
* @tomdstone made their first contribution in [#6261](https://github.com/psychopy/psychopy/issues/6261)
* @zuazo made their first contribution in [#6299](https://github.com/psychopy/psychopy/issues/6299)
...
* Handle errors when loading list of plugins by @TEParsons in [#6334](https://github.com/psychopy/psychopy/issues/6334)
* Counterbalance in online studies was still trying to confirm entries after finishing by @TEParsons in [#6345](https://github.com/psychopy/psychopy/issues/6345)
* Make sure the drawn max time in Builder is never None by @TEParsons in [#6347](https://github.com/psychopy/psychopy/issues/6347)
* Fixed translation issues by @hsogo in [#6348](https://github.com/psychopy/psychopy/issues/6348)
* Fixed inability to load plugins list from local with non-utf-8 default encoding by @peircej in [#6349](https://github.com/psychopy/psychopy/issues/6349)
...
**Enhancements**
* Default TextStim font set to Arial (TextBox default was already Arial) by @wakecarter in [#6378](https://github.com/psychopy/psychopy/issues/6378)

**Bug fixes** 

* Keyboard clock wasn't being reset properly, so `.rt` values were from exp start by @TEParsons in [#6360](https://github.com/psychopy/psychopy/issues/6360)
* Safer (and faster) behaviour when copying a param, avoids "infinite recursion" (app hangs) by @TEParsons in [#6362](https://github.com/psychopy/psychopy/issues/6362)
* Make line spacing specific to just one TextBox2 object by @Catherine9811 in [#6356](https://github.com/psychopy/psychopy/issues/6356)
* Fixes to the Gazepoint eyetracker plugin by @mdcutone in [#6365](https://github.com/psychopy/psychopy/issues/6365)
* Fixed error when camera tries to close when it's already closed by @mdcutone in [#6364](https://github.com/psychopy/psychopy/issues/6364)
* Fixed editable TextBox2 cursor location with line breaks by @Catherine9811 in [#6358](https://github.com/psychopy/psychopy/issues/6358)
* Remove "constant" updates option from SoundComponent (as it wasn't used) by @TEParsons in [#6351](https://github.com/psychopy/psychopy/issues/6351)
* Python 3.8 was falsely marked as incompatible with 2024.1.x onwards in "use version" interface by @TEParsons in [#6366](https://github.com/psychopy/psychopy/issues/6366)
* Form Component wasn't finding the correct table template by @TEParsons in [#6381](https://github.com/psychopy/psychopy/issues/6381)
* Remove blank rows from form template by @wakecarter in [#6382](https://github.com/psychopy/psychopy/issues/6382)
* Error saving icons from plugin details by @TEParsons in [#6368](https://github.com/psychopy/psychopy/issues/6368)
* Transparent colours online by @wakecarter in [#6386](https://github.com/psychopy/psychopy/issues/6386)
* Button numclicks defined by timesOn.length by @wakecarter in [#6385](https://github.com/psychopy/psychopy/issues/6385)

**Documentation and testing improvements** by... @peircej @TEParsons @kimDundas @suelynnmah

**New contributors: **

* @Catherine9811 made their first contribution in [#6356](https://github.com/psychopy/psychopy/issues/6356)
...
* Telling Mouse Component to check new clicks without clickable stim raised syntax error by @TEParsons in [#6398](https://github.com/psychopy/psychopy/issues/6398)
* Keyboard responses in ioHub weren't using relative time by @TEParsons in [#6407](https://github.com/psychopy/psychopy/issues/6407)
...
* ioHub keyboard was registering key releases before presses, so duration was always None. We now have a test in place that confirms keyboard RT timing using hardware which will be used on each new release going forwards. By @TEParsons in [#6416](https://github.com/psychopy/psychopy/issues/6416)
* Fixed some translation issues by @hsogo in [#6409](https://github.com/psychopy/psychopy/issues/6409)
* Fixed JSON encoding error when opening plugin dialog by @mdcutone in [#6411](https://github.com/psychopy/psychopy/issues/6411)

**Documentation updates**

* updated screenshots by @charlottej3673 in [#6392](https://github.com/psychopy/psychopy/issues/6392)

PsychoPy 2024.1.5
~~~~~~~~~~~~~~~~~

* Failing to find Eyetracker Components (Eyelink by @KirstenWilliams in [#6406](https://github.com/psychopy/psychopy/issues/6406) and Gazepoint by @mdcutone in [#6424](https://github.com/psychopy/psychopy/issues/6424) )
* Installed plugins were not being found on Linux/MacOS by @mdcutone in [#6441](https://github.com/psychopy/psychopy/issues/6441)
* Faster MovieStim rendering (don't call `play()` when already playing) by @aforren1 in [#6448](https://github.com/psychopy/psychopy/issues/6448)
* Fixed eyetracker calibration target units (height -> pix) by @peircej in [#6451](https://github.com/psychopy/psychopy/issues/6451)
* KeyboardComponent allowed keys from spreadsheet caused namespace errors by @TEParsons in [#6458](https://github.com/psychopy/psychopy/issues/6458)
* hide that visible mouse, please by @mh105 in [#6465](https://github.com/psychopy/psychopy/issues/6465)
* Fix an issue with etRecord component for Stop Only (not stopping the eytracker) by @mh105 in [#6463](https://github.com/psychopy/psychopy/issues/6463)
* Only change Mouse visibility if explicitly asked to by @TEParsons in [#6467](https://github.com/psychopy/psychopy/issues/6467)
* Fix "Stop only" issue regardless of Component order by @TEParsons in [#6468](https://github.com/psychopy/psychopy/issues/6468)
* Clear keys to initialize keyboard when starting a routine by @mh105 in [#6471](https://github.com/psychopy/psychopy/issues/6471)
* Allow getKeys() to return the same key pressed multiple times by @mh105 in [#6479](https://github.com/psychopy/psychopy/issues/6479)

## Documentation fixes and updates

* by @suelynnmah in [#6341](https://github.com/psychopy/psychopy/issues/6341) [#6426](https://github.com/psychopy/psychopy/issues/6426) [#6427](https://github.com/psychopy/psychopy/issues/6427)
* by @KirstenWilliams in [#6480](https://github.com/psychopy/psychopy/issues/6480) [#6481](https://github.com/psychopy/psychopy/issues/6481) [#6487](https://github.com/psychopy/psychopy/issues/6487) [#6498](https://github.com/psychopy/psychopy/issues/6498) [#6506](https://github.com/psychopy/psychopy/issues/6506)
* by @RebeccaHirst in [#6504](https://github.com/psychopy/psychopy/issues/6504) [#6505](https://github.com/psychopy/psychopy/issues/6505) 
* Arabic app translations by @Ahmad-Abudoush in [#6476](https://github.com/psychopy/psychopy/issues/6476)
...
* PsychoJS: Mobile-friendly viewport settings. by @lightest in [#5380](https://github.com/psychopy/psychopy/issues/5380)
* Allow experiment to run with different clocks (e.g. wall clock time instead of starting at t=0) by @TEParsons in [#5621](https://github.com/psychopy/psychopy/issues/5621)
* PsychoJS ShapeStim from Builder now supports custom vertices by @TEParsons in [#5522](https://github.com/psychopy/psychopy/issues/5522)
* Numerous improvements to plugins system and dialog
* Added `abortCurrentTrial` (Python only for now) method to `TrialHandler2` and `MultiStairHandler` by @mdcutone in [#5423](https://github.com/psychopy/psychopy/issues/5423)
* Better performance and fixes to FFPyPlayer movie engine
* Added `letterSpacing` attribute to Textbox by @TEParsons in [#5487](https://github.com/psychopy/psychopy/issues/5487)
...
* Preserve tab order for Routines when saving/loading an experiment by @TEParsons in [#5517](https://github.com/psychopy/psychopy/issues/5517)
* Added audio settings to Camera component by @mdcutone in [#5681](https://github.com/psychopy/psychopy/issues/5681)
* Improved streaming of camera to disk by @mdcutone in [#5551](https://github.com/psychopy/psychopy/issues/5551)
* Window now explains it is performing timing test by @mdcutone in [#5511](https://github.com/psychopy/psychopy/issues/5511)
* Keyboard Components from Builder will store duration if available (if release has already occurred) by @TEParsons in [#5569](https://github.com/psychopy/psychopy/issues/5569)
* Show status text for objects in Flow panel by @TEParsons in [#5443](https://github.com/psychopy/psychopy/issues/5443)
* Make psychopy.Window title (and icon in pyglet) settable by @TEParsons in [#5540](https://github.com/psychopy/psychopy/issues/5540)
* UI enhancements to Coder and Runner by @TEParsons in [#5539](https://github.com/psychopy/psychopy/issues/5539)
* Multihead support for X11/Linux by @mdcutone in [#5520](https://github.com/psychopy/psychopy/issues/5520)
* Plugins Dialog now checks for version compatibility with PsychoPy by @TEParsons in [#5649](https://github.com/psychopy/psychopy/issues/5649)
* Install plugins to subdirectories by @mdcutone in [#5398](https://github.com/psychopy/psychopy/issues/5398)
* Make Save & Edit/View buttons on README window more explicit by @TEParsons in [#5523](https://github.com/psychopy/psychopy/issues/5523)
* New option to abbreviate long component names in Preferences, fixes [#5574](https://github.com/psychopy/psychopy/issues/5574) by @TEParsons in [#5586](https://github.com/psychopy/psychopy/issues/5586)
* Highlight selected Routine in Flow panel by @TEParsons in [#5588](https://github.com/psychopy/psychopy/issues/5588)
* Better Builder visualisation very large experiments by @TEParsons in [#5618](https://github.com/psychopy/psychopy/issues/5618)
* Lock Flow panel buttons to the left when scrolling by @TEParsons in [#5620](https://github.com/psychopy/psychopy/issues/5620)
* ExperimentHandler.addData() now has optional `row` argument to specify previous entry by @TEParsons in [#5652](https://github.com/psychopy/psychopy/issues/5652)
* Fixed useVersion warning untracked working tree files would be overwritten by @peircej in [#5670](https://github.com/psychopy/psychopy/issues/5670)
* Add param to control whether movies/sounds end when the Routine does, by @TEParsons in [#5415](https://github.com/psychopy/psychopy/issues/5415)
* Add "transparent" as named color by @TEParsons in [#5689](https://github.com/psychopy/psychopy/issues/5689)
* Radio button styling was not work in Slider component in 2023.1, fixes [#5661](https://github.com/psychopy/psychopy/issues/5661) (dev) by @TEParsons in [#5691](https://github.com/psychopy/psychopy/issues/5691)
* Allow expInfo fields to be marked as required (*) by @ainazay in [#5543](https://github.com/psychopy/psychopy/issues/5543)
* Fix VlcMovieStim by @marcpabst in [#5702](https://github.com/psychopy/psychopy/issues/5702)
* Added data file separator to expInfo by @EitanHemed in [#5607](https://github.com/psychopy/psychopy/issues/5607)
* Minor Textbox bugfixes by @ollie-d in [#5723](https://github.com/psychopy/psychopy/issues/5723)
* Extended autotranslate functions supported by py2js by @roelofsaj in [#5713](https://github.com/psychopy/psychopy/issues/5713)
* Submitting GitHub issues now supports templates by @shun2wang in [#5732](https://github.com/psychopy/psychopy/issues/5732)
...
* Fixed missing comma in Brush component code by @TEParsons in [#5564](https://github.com/psychopy/psychopy/issues/5564)
* Mouse position incorrect when desktop scaling not 100% on Windows by @mdcutone in [#5758](https://github.com/psychopy/psychopy/issues/5758)
* Fixed `AttributeError: 'SoundPTB' object has no attribute 'isFinished'` by @mdcutone in [#5541](https://github.com/psychopy/psychopy/issues/5541)
* Better handling of missing audio libraries - allow the app to load always and fallback to PsychToolBox if possible
* Better handling of Mouse.getPos() when no windows open  by @peircej in [#5763](https://github.com/psychopy/psychopy/issues/5763)
* Param updates code for Sound in JS was using Python syntax by @TEParsons in [#5762](https://github.com/psychopy/psychopy/issues/5762)
* More informative error when useVersion fails to write script by @TEParsons in [#5761](https://github.com/psychopy/psychopy/issues/5761)
* saveAsWideText was using deprecated DataFrame.append function by @TEParsons in [#5507](https://github.com/psychopy/psychopy/issues/5507)
* Polygon/ROI vertices caused error if trying to set each frame by @TEParsons in [#5686](https://github.com/psychopy/psychopy/issues/5686)
* Don't crash if user attempts to initialise ioHub more than once by @TEParsons in [#5533](https://github.com/psychopy/psychopy/issues/5533)
* Added log file entry for Keyboard.clearEvents() by @peircej in [#5558](https://github.com/psychopy/psychopy/issues/5558)
* Fixed missing movie file in MoviePause.py demo by @EitanHemed in [#5583](https://github.com/psychopy/psychopy/issues/5583)
* Coder source tree thought any variable name beginning with `def` was a function def by @TEParsons in [#5581](https://github.com/psychopy/psychopy/issues/5581)
* README filename wasn't being updated for new frames by @TEParsons in [#5593](https://github.com/psychopy/psychopy/issues/5593)
* Fix Markdown parsing on README files by @TEParsons in [#5572](https://github.com/psychopy/psychopy/issues/5572)
* Ignore Escape in Keyboard component if needed to end experiment by @TEParsons in [#5598](https://github.com/psychopy/psychopy/issues/5598)
* Joystick component - SyntaxError in generated code by @EitanHemed in [#5601](https://github.com/psychopy/psychopy/issues/5601)
* Error `got an unexpected keyword argument "reset"` when trying to pause using PTB sounds by @peircej in [#5619](https://github.com/psychopy/psychopy/issues/5619)
* PsychoPJS: Fix issue with first frame of image being shown as default.png in JS by @TEParsons in [#5716](https://github.com/psychopy/psychopy/issues/5716)
* Add `self` to list of disallowed Component names by @TEParsons in [#5742](https://github.com/psychopy/psychopy/issues/5742)
* Split compound Survey answers into individual columns by @TEParsons in [#5734](https://github.com/psychopy/psychopy/issues/5734)
* Fixed audio file not resetting during (Python) experiment by @mdcutone in [#5712](https://github.com/psychopy/psychopy/issues/5712)
* If trying to load previously open file that is corrupted, do at least open the app (with an empty window) by @TEParsons in [#5696](https://github.com/psychopy/psychopy/issues/5696)
* Better catching of name errors in conditions file by @TEParsons in [#5654](https://github.com/psychopy/psychopy/issues/5654)

**New contributors:**

* @ranibaron made their first contribution in [#5394](https://github.com/psychopy/psychopy/issues/5394)
* @patrickabolger made their first contribution in [#5414](https://github.com/psychopy/psychopy/issues/5414)
* @fboers made their first contribution in [#5482](https://github.com/psychopy/psychopy/issues/5482)
* @gtosh4 made their first contribution in [#5609](https://github.com/psychopy/psychopy/issues/5609)
* @ainazay made their first contribution in [#5543](https://github.com/psychopy/psychopy/issues/5543)
* @marcpabst made their first contribution in [#5702](https://github.com/psychopy/psychopy/issues/5702)
...
* Eyetracker plugins were not being detected by Builder by @peircej in [#5808](https://github.com/psychopy/psychopy/issues/5808)
* Fix device selection for Microphone component by @mdcutone in [#5811](https://github.com/psychopy/psychopy/issues/5811)
* ioHub reporting negative response times by @TEParsons in [#5807](https://github.com/psychopy/psychopy/issues/5807)
* Add attributeSetter / set functions for borderWidth by @TEParsons in [#5779](https://github.com/psychopy/psychopy/issues/5779)
* Option for hiding splash screen available in Preferences by @TEParsons in [#5776](https://github.com/psychopy/psychopy/issues/5776)
* `endExpNow` was only defined if Escape was enabled by @TEParsons in [#5780](https://github.com/psychopy/psychopy/issues/5780)
* Polygon JS from Builder failing to initialise code by @TEParsons in [#5783](https://github.com/psychopy/psychopy/issues/5783)
* Copied Routines were getting two Routine Settings components by @TEParsons in [#5792](https://github.com/psychopy/psychopy/issues/5792)
* Fix unresponsive scrolling in Routine canvas by @TEParsons in [#5795](https://github.com/psychopy/psychopy/issues/5795)
* update Japanese translation by @hsogo in [#5789](https://github.com/psychopy/psychopy/issues/5789)
* If rewinding Sound (seek to before end) then mark as not finished by @TEParsons in [#5781](https://github.com/psychopy/psychopy/issues/5781)
* Fixed <expname>_legacy-legacy-browser.js is not a file by @TEParsons in [#5799](https://github.com/psychopy/psychopy/issues/5799)
* Coder was making an error when opening a new file by @TEParsons in [#5801](https://github.com/psychopy/psychopy/issues/5801)
* Conditions file was being cleared when loop type is "interleaved staircase" by @TEParsons in [#5803](https://github.com/psychopy/psychopy/issues/5803)
* Add JS code to set window background image on init by @TEParsons in [#5806](https://github.com/psychopy/psychopy/issues/5806)
* MacOS iohub "TypeError: startswith first arg must be bytes..." by @peircej in [#5812](https://github.com/psychopy/psychopy/issues/5812)
* New projects sometimes wouldn't have a local root by @TEParsons in [#5814](https://github.com/psychopy/psychopy/issues/5814)
* Handle when Static Component tries to set param of deleted/disabled Component by @TEParsons in [#5815](https://github.com/psychopy/psychopy/issues/5815)
* Python 3.10 version bump had broken GIF avatars by @TEParsons in [#5791](https://github.com/psychopy/psychopy/issues/5791)
...
* Fixed ioHub keyboard timing (was using incorrect timestamp offset) by @TEParsons in [#5807](https://github.com/psychopy/psychopy/issues/5807)
* Fixed locating config files for ioHub extensions which prevented them from loading by @mdcutone in [#5821](https://github.com/psychopy/psychopy/issues/5821)
* Fixed bug whereby iohub couldn't find plugin backends on Mac by @TEParsons in [#5824](https://github.com/psychopy/psychopy/issues/5824)
* Better handing of experiments with Components that are now only in plugins by @TEParsons in [#5834](https://github.com/psychopy/psychopy/issues/5834) [#5831](https://github.com/psychopy/psychopy/issues/5831) [#5833](https://github.com/psychopy/psychopy/issues/5833)
* Fixed "logFile does not exist" error when "Save log file" is False by @TEParsons in [#5836](https://github.com/psychopy/psychopy/issues/5836)
* Fixed matrix question breaking apart code in Survey Routine by @TEParsons in [#5840](https://github.com/psychopy/psychopy/issues/5840)
* Allow expInfo to use values from Code components without overriding them by @TEParsons in [#5837](https://github.com/psychopy/psychopy/issues/5837)
* Fixed error in Form when using a radio ctrl by @TEParsons in [#5843](https://github.com/psychopy/psychopy/issues/5843)
* Polygon broken in JavaScript code from Builder by @TEParsons in [#5844](https://github.com/psychopy/psychopy/issues/5844)
* Ignore spaces when getting variables from name by @TEParsons in [#5841](https://github.com/psychopy/psychopy/issues/5841)
* "tThisFlip not defined" error when using Routine stop time online by @TEParsons in [#5849](https://github.com/psychopy/psychopy/issues/5849)
* "eyetracker is not defined" error on experiment quit by @TEParsons in [#5850](https://github.com/psychopy/psychopy/issues/5850)
* Fixed incorrect formatting in `AudioDeviceInfo` `__repr__` by @mdcutone in [#5851](https://github.com/psychopy/psychopy/issues/5851)
* Fixed message order in Plugins dialog output by @TEParsons in [#5865](https://github.com/psychopy/psychopy/issues/5865)
* Update path of README dialog on "save as" by @TEParsons in [#5863](https://github.com/psychopy/psychopy/issues/5863)
* Fixed sounds restarting at the end of a Routine where they had perviously stopped by @peircej in [#5874](https://github.com/psychopy/psychopy/issues/5874)

**Various documentation updates:**

* Progress bar API and documentation by @suelynnmah in [#5822](https://github.com/psychopy/psychopy/issues/5822)
* Bart Builder demo fix by @suelynnmah in [#5823](https://github.com/psychopy/psychopy/issues/5823)
* psychophysicsStaircase demo fix by @suelynnmah in [#5829](https://github.com/psychopy/psychopy/issues/5829)
* Fix colors demo by @TEParsons in [#5838](https://github.com/psychopy/psychopy/issues/5838)
* Sternberg Builder demo - checked save log file to remove logFile error by @suelynnmah in [#5845](https://github.com/psychopy/psychopy/issues/5845)
...
* Fixed error detecting eyetracker config files by @TEParsons in [#5883](https://github.com/psychopy/psychopy/issues/5883) [#5886](https://github.com/psychopy/psychopy/issues/5886)
* Fixed eyetracker calibration routine freezing by @mdcutone in [#5901](https://github.com/psychopy/psychopy/issues/5901)
* Fixed support for updated Pupil Labs plugin w/ support for Neon by @domstoppable in [#5887](https://github.com/psychopy/psychopy/issues/5887)
* Fixed useVersion for JS - needed to create a _legacy.js file by @TEParsons in [#5918](https://github.com/psychopy/psychopy/issues/5918)
* Fixed SerialOut parity should be N not None by @TEParsons in [#5907](https://github.com/psychopy/psychopy/issues/5907)
* Fixed bug whereby Textbox's scrolling Aperture was applied to all stim by @TEParsons in [#5934](https://github.com/psychopy/psychopy/issues/5934)
...
* @meltemkaraca made their first contribution in [#5891](https://github.com/psychopy/psychopy/issues/5891)
* @SarvCh made their first contribution in [#5893](https://github.com/psychopy/psychopy/issues/5893)
* @ymhuang1005 made their first contribution in [#5894](https://github.com/psychopy/psychopy/issues/5894)
* @ice-yu made their first contribution in [#5895](https://github.com/psychopy/psychopy/issues/5895)
* @domstoppable made their first contribution in [#5887](https://github.com/psychopy/psychopy/issues/5887)
* @jingrun213 made their first contribution in [#5897](https://github.com/psychopy/psychopy/issues/5897)
* @psych575 made their first contribution in [#5912](https://github.com/psychopy/psychopy/issues/5912)
...
* Fix crash following gamma semi-auto correction (when laying out dialog box) dialog box by @TEParsons in [#5452](https://github.com/psychopy/psychopy/issues/5452)
* Crashing due to outdated `core.getFromNames` in Mouse by @TEParsons in [#5474](https://github.com/psychopy/psychopy/issues/5474)
* Setting Image as a numpy array caused a TypeError by @TEParsons in [#5453](https://github.com/psychopy/psychopy/issues/5453)
* Handle invalid paths when stringifying params by @TEParsons in [#5465](https://github.com/psychopy/psychopy/issues/5465)
* Swap all references to Panorama.altitude with Panorama.elevation by @TEParsons in [#5471](https://github.com/psychopy/psychopy/issues/5471)
* Fix typo in Survey routine - `stauts` rather than `status` by @TEParsons in [#5468](https://github.com/psychopy/psychopy/issues/5468)
* If user requests showing README and there isn't one then show a blank file @TEParsons in [#5470](https://github.com/psychopy/psychopy/issues/5470)
* Fix typos in high contrast theme by @TEParsons in [#5504](https://github.com/psychopy/psychopy/issues/5504)
* Sound files online were playing forever if duration set to <0.5s by @TEParsons in [#5466](https://github.com/psychopy/psychopy/issues/5466)
* Let Builder treat Sound.isPlaying and Sound.status==STARTED as synonymous by @TEParsons in [#5428](https://github.com/psychopy/psychopy/issues/5428)
* Correctly ignore blank columns by @wader in [#5406](https://github.com/psychopy/psychopy/issues/5406)
* Viewport was left as None when checkTiming was unticked by @TEParsons in [#5451](https://github.com/psychopy/psychopy/issues/5451)
* Better handling when a Pavlovia project / plugin avatars in the app @TEParsons in [#5458](https://github.com/psychopy/psychopy/issues/5458) [#5460](https://github.com/psychopy/psychopy/issues/5460) [#5469](https://github.com/psychopy/psychopy/issues/5469)

**Documentation fixes by**

* @roelofsaj in [#5477](https://github.com/psychopy/psychopy/issues/5477) [#5483](https://github.com/psychopy/psychopy/issues/5483) [#5484](https://github.com/psychopy/psychopy/issues/5484)
* @ChenBri in [#5478](https://github.com/psychopy/psychopy/issues/5478) [#5480](https://github.com/psychopy/psychopy/issues/5480)
* @ChristopheBossens in [#5481](https://github.com/psychopy/psychopy/issues/5481)
* @suelynnmah in [#5444](https://github.com/psychopy/psychopy/issues/5444)

**New Contributors**

* @roelofsaj made their first contribution in [#5477](https://github.com/psychopy/psychopy/issues/5477)
* @ChenBri made their first contribution in [#5478](https://github.com/psychopy/psychopy/issues/5478)
* @ChristopheBossens made their first contribution in [#5481](https://github.com/psychopy/psychopy/issues/5481)
* @wader made their first contribution in [#5406](https://github.com/psychopy/psychopy/issues/5406)
...
- Better plugin handling:
  ...
  - Better handling of plugin dependencies (moved to sub-folders) [#5398](https://github.com/psychopy/psychopy/issues/5398)
  - More responsive plugins dialog (not waiting for all plugin info to populate) [#5410](https://github.com/psychopy/psychopy/issues/5410)
  - Live info updates as the plugin installs [#5399](https://github.com/psychopy/psychopy/issues/5399)
  - Sort package versions newest first [commit:a4987c95f](https://github.com/psychopy/psychopy/commit/a4987c95f)

- Panorama stimulus no longer needs FBO=False on Window
- MovieStim locally opacity was not being honored [commit:094731084](https://github.com/psychopy/psychopy/commit/094731084)
- MovieStim online crashed if using setEveryRepeat [commit:ed484ba17](https://github.com/psychopy/psychopy/commit/ed484ba17)
- Close eyetracker connection if experiment ends early [commit:f9b6f98e4](https://github.com/psychopy/psychopy/commit/f9b6f98e4)
- README dialog was created twice [#5383](https://github.com/psychopy/psychopy/issues/5383)
- Online Experiments with image sitmuli crashing with unknown resource "default.png"
- Nested loops were crashing
- Fixed various failures to translate [commit:804bfcde2](https://github.com/psychopy/psychopy/commit/804bfcde2) [commit:b1b611ec1](https://github.com/psychopy/psychopy/commit/b1b611ec1)
- Console gave encoding errors when opening MacOS csv files on Windows machines [#5396](https://github.com/psychopy/psychopy/issues/5396)
- Failure to log in to Pavlovia [#5382](https://github.com/psychopy/psychopy/issues/5382) [#5450](https://github.com/psychopy/psychopy/issues/5450)
...
- App: improved performance when the Shell has a large amount of text [commit:f1e8d6bf7](https://github.com/psychopy/psychopy/commit/f1e8d6bf7)
- App: fixed the use of tab traversal within Component dialogs on MacOS [commit:a618c4cd7](https://github.com/psychopy/psychopy/commit/a618c4cd7)
- Python: fixed setting the first position of markers on Sliders
- Python: experiments using ioHub Keyboard backend were registering keypresses twice (once for down and again for up) [#4990](https://github.com/psychopy/psychopy/issues/4990)
...
- App: non-slip Routines not being terminated properly by force-end-routine [#5004](https://github.com/psychopy/psychopy/issues/5004)
- Packaging: removed PocketSphinx from requirements (hard to install on several systems)
- App: translations of some choice fields into Japanese not working correctly [#5009](https://github.com/psychopy/psychopy/issues/5009)
...
- Sound.pause() was resetting to start of track [commit:a161e135a](https://github.com/psychopy/psychopy/commit/a161e135a)
...
- fixes to connection from Builder to Pavlovia in certain circumstances (e.g. certain usernames or when
  project has moved) [commit:22963a9](https://github.com/psychopy/psychopy/commit/22963a9)
- fixes searches of Pavlovia for private projects by the logged in user
- fix to use of correct answers for Joystick Buttons Component [commit:2e66dc1](https://github.com/psychopy/psychopy/commit/2e66dc1) [commit:f9ef1be](https://github.com/psychopy/psychopy/commit/f9ef1be)
- Builder crashing when a Routine had been copied over [commit:4592876](https://github.com/psychopy/psychopy/commit/4592876)
- some parameters in Builder dialogs were missing their label names [commit:c8cd380](https://github.com/psychopy/psychopy/commit/c8cd380)
- ShapeStim was not obeying requests for zero opacity [commit:8030b2f](https://github.com/psychopy/psychopy/commit/8030b2f)
- fixed "currentLoop is not defined" error for online studies [commit:a261d04](https://github.com/psychopy/psychopy/commit/a261d04)
- in certain circumstances, mic recordings were not saving for each trial, only for the last trial,
  when online [commit:5e23a0a](https://github.com/psychopy/psychopy/commit/5e23a0a)
...
- Slider styleTweaks were not being applied [#4773](https://github.com/psychopy/psychopy/issues/4773)
- Check that file is saved before trying to Run [#4759](https://github.com/psychopy/psychopy/issues/4759)
- Mouse coordinate mapping was incorrect for MacOS Retina displays which meant that Slider and Brush wasn't working, for instance [#4755](https://github.com/psychopy/psychopy/issues/4755)
- Allow the Sound Component to be used if transcription libs were not available [#4747](https://github.com/psychopy/psychopy/issues/4747)
- Form Component excel template was corrupted (by google sheets export) [#4742](https://github.com/psychopy/psychopy/issues/4742)
- Copying a Routine from one experiment to another was causing a compile error [#4740](https://github.com/psychopy/psychopy/issues/4740)
- Better logging of errors during application load for debugging purposes [#4750](https://github.com/psychopy/psychopy/issues/4750)
- Setting the Slider to reset() was looking like a response when it shouldn't [#4738](https://github.com/psychopy/psychopy/issues/4738)
...
- If HomeBrew has a broken fonts folder ignore it [#4719](https://github.com/psychopy/psychopy/issues/4719)
...
- URL redirection was failing at the end of the study for online experiments
  ...
  replacement of `//` with `/` in `https://` [commit:e8218b31f](https://github.com/psychopy/psychopy/commit/e8218b31f71)
- Hyphens can now be included in Pavlovia project names (the validator in the
  PsychoPy GUI was being too strict) [commit:bbe6bf5ed](https://github.com/psychopy/psychopy/commit/bbe6bf5ed01)
...
- Fixed a bug where, after logging out of the Pavlovia Session in the PsychoPy
  ...
  [commit:bbe6bf5ed](https://github.com/psychopy/psychopy/commit/bbe6bf5ed01d26)
- PsychoPy would crash if using the Classic Theme on a mac with a retina display
  (missing icons) [commit:495fddd81](https://github.com/psychopy/psychopy/commit/495fddd814ce1e0)
- DotStim in local (Python) experiments was failing to update dots position [#4694](https://github.com/psychopy/psychopy/issues/4694)
- Error raised when creating a new Pavlovia project from the menu item rather
  than the toolbar button [#4683](https://github.com/psychopy/psychopy/issues/4683)
...
- added cryptography lib explicitly to requirements for pip install [commit:267483d00](https://github.com/psychopy/psychopy/commit/267483d00)
- Runner local debug of PsychoJS experiments was failing with MIME-type errors (Runner didn't know about new psychojs packaging) [#4153](https://github.com/psychopy/psychopy/issues/4153)
- extended timeout when querying Pavlovia from the app (e.g. searching for projects) [#4148](https://github.com/psychopy/psychopy/issues/4148)
- corrected reset of clock for new Button Component
- DlgFromDict was crashing if `labels` were used (in code) [#4137](https://github.com/psychopy/psychopy/issues/4137)
- short (<0.5s) sounds were not labelled as finished in PsychoJS boilerplate [#4117](https://github.com/psychopy/psychopy/issues/4117)
- contrast parameter was not being applied to ShapeStim [#4111](https://github.com/psychopy/psychopy/issues/4111)
...
- Builder outputs weren't fully honouring the `userVersion()` request, resulting in broken PsychoJS code [commit:5f10b0a12](https://github.com/psychopy/psychopy/commit/5f10b0a12) [commit:017c18f2f](https://github.com/psychopy/psychopy/commit/017c18f2f31e)
...
- Builder boilerplate for Microphone was looking for a transcription even if none was requested [#4163](https://github.com/psychopy/psychopy/issues/4163)
...
<span style="color:red">CHANGES (compatibility issues):</span>

- <span style="color:red">CHANGED: the new more-flexible parameters of PsychoPy Experiment Components makes experiments from 2021.1 **will not run** on older versions of PsychoPy. If you share your study with people using older versions make sure you set the :ref:'useVersion' setting to be 2021.1.0 or upwards so that it will run elsewhere</span>
- <span style="color:red">CHANGED: PsychoJS: orientation for PsychoJS now follows clock convention rather than engineering convention (polar coordinates, positive rotation is anti-clockwise) whereas PsychoPy used the clock convention. From this release onwards both use the clock convention or orientation/rotation.</span>
- <span style="color:red">CHANGED: Slider has additional params for colors and fonts of lines/labels/marker that will not exist on older installations</span>
- <span style="color:red">CHANGED: BufferImageStim was using an incorrect rect specification for selecting the region of the screen - it was using a bottom-left instead of PsychoPy standard center [#3597](https://github.com/psychopy/psychopy/issues/3597)</span>
...
- Online: Slider sizing, tick placement, and event handling improvements. [#249](https://github.com/psychopy/psychopy/issues/249) [#263](https://github.com/psychopy/psychopy/issues/263) [#264](https://github.com/psychopy/psychopy/issues/264)
...
- Brush component now has an option to allow drawing without having to hold down the mouse button [#2980](https://github.com/psychopy/psychopy/issues/2980)
...
- Failing to send print statements to output, depending on how PsychoPy was launched [commit:4773ec32d](https://github.com/psychopy/psychopy/commit/4773ec32dcf) Only occurred if you launch by double-clicking file or if you close Runner
...
- improved search for resources files when compiling JS (was crashing if using root folder and using code to specify the conditions file) [commit:09816985d](https://github.com/psychopy/psychopy/commit/09816985d5)
- the `Before Experiment` section of Code Components wasn't being written for JavaScript components [commit:bbfd310](https://github.com/psychopy/psychopy/commit/bbfd310)
- error with wx complaining about Alignment (in wx 4.1) [commit:a32e2ca](https://github.com/psychopy/psychopy/commit/a32e2ca) [commit:ae508d6](https://github.com/psychopy/psychopy/commit/ae508d6)
...
- themes menu correctly updates what the current them is in all open windows [commit:c5cdc49](https://github.com/psychopy/psychopy/commit/c5cdc49)
- custom fonts that didn't provide a "family name" were causing the font search to crash [commit:ef078ab](https://github.com/psychopy/psychopy/commit/ef078ab)
- bug trying to us an invalid "useRunner" preference 3532e4c
- JavaScript studies failed if there were 2 Mouse Components in a single Routine [commit:0e0b26d4d](https://github.com/psychopy/psychopy/commit/0e0b26d4dcc) [commit:32a6be2](https://github.com/psychopy/psychopy/commit/32a6be2)
- improved Big Five Inventory demo
- blank TextBox Component should use blank string rather than None [commit:39bf1bb](https://github.com/psychopy/psychopy/commit/39bf1bb)
- further fix to macOS stapling (might not have worked for users with no internet connection?)
- Form Component now honors being set to show only at certain times (in keeping with other visual Components) [commit:35ad5bc](https://github.com/psychopy/psychopy/commit/35ad5bc)
...
- **auto-translate py->js for parameters with $** We were translating code components but not parameter boxes where the user was switching to code using $  [#3064](https://github.com/psychopy/psychopy/issues/3064)
- better handling when a piece of code fails to convert (warning not error) [#3063](https://github.com/psychopy/psychopy/issues/3063)
- show progress (in Runner) while syncing project with Pavlovia [#3061](https://github.com/psychopy/psychopy/issues/3061)
...
- Runner was not launching Coder scripts from their own directory [#2819](https://github.com/psychopy/psychopy/issues/2819)
- csv files should allow separator to be `;` and decimal place to be `,` [#2825](https://github.com/psychopy/psychopy/issues/2825) [#2828](https://github.com/psychopy/psychopy/issues/2828)
- PsychoPy application was now launching in Windows versions <8.1 (which don't know about high-dpi displays) [#2820](https://github.com/psychopy/psychopy/issues/2820)

PsychoPy 2020.1.2
~~~~~~~~~~~~~~~~~~~~~~

- Keypad key responses were not showing up as numbered responses under the new Keyboard class [#2812](https://github.com/psychopy/psychopy/issues/2812)
- Cedrus button box had an error int he Builder-output code added in 2020.1.1 [commit:186ec5876](https://github.com/psychopy/psychopy/commit/186ec587634)
- Code Component was accidentally *forcing* people to use code auto-conversion [commit:5c57d0c9d](https://github.com/psychopy/psychopy/commit/5c57d0c9d)
...
- Fixes to Eyelink 1000 communications from iohub [commit:1a8c6923b](https://github.com/psychopy/psychopy/commit/1a8c6923b0)
- Better support for high-res displays on Windows [#2795](https://github.com/psychopy/psychopy/issues/2795)
- Further tweak to readline issues on linux [commit:6975040fa](https://github.com/psychopy/psychopy/commit/6975040fae) [commit:4a80060b9](https://github.com/psychopy/psychopy/commit/4a80060b94)
...
- Slider wasn't allowing the units to be "from experiment settings" [commit:23d80b49f](https://github.com/psychopy/psychopy/commit/23d80b49f)
- Setting the conditions rows from another conditions file was causing "Error path is on mount... start on mount..." [commit:2e8cd2183](https://github.com/psychopy/psychopy/commit/2e8cd2183)
- Mac 'tab' key was reporting itself as 'escape' with new Keyboard [commit:95326cadd](https://github.com/psychopy/psychopy/commit/95326cadd)
- PSTBox Python3 incompatibility (although there may be more) [commit:da83429d6](https://github.com/psychopy/psychopy/commit/da83429d6)
- better scaling of rating scale (Slider) in Form [commit:d115e63cb](https://github.com/psychopy/psychopy/commit/d115e63cb)
- Stencil for Form was being activated immediately rather than when needed [commit:9daeba94d](https://github.com/psychopy/psychopy/commit/9daeba94d)
...
- Cedrus response box now supports keys as a variable value in Builder [#2608](https://github.com/psychopy/psychopy/issues/2608)
- QuestPlusHandler now supports "unknown" kwargs [#2610](https://github.com/psychopy/psychopy/issues/2610)
...
- timing of first frame was being given an extra (unnecessary) delay if images were loaded [commit:8ddab41](https://github.com/psychopy/psychopy/commit/8ddab41)
- potential app crashes if no internet available [commit:63aa7e0](https://github.com/psychopy/psychopy/commit/63aa7e0) [commit:b3e15f9](https://github.com/psychopy/psychopy/commit/b3e15f9)
- Builder under OS X was not launching experiments if filename contained a space [commit:1b205df](https://github.com/psychopy/psychopy/commit/1b205df)

PsychoPy 3.2.1
~~~~~~~~~~~~~~~~~~~~~~

- Python2 installations crashed when trying to launch studies from Builder due to the use of a modern argument to subprocess not supported by Python2 [#2596](https://github.com/psychopy/psychopy/issues/2596)
- If Builder script had an error, then printing of that error was sometimes being split across the output frame (of Builder) and the output panel of Coder [#2594](https://github.com/psychopy/psychopy/issues/2594)
...
- new rendering glitch in ImageStim when mask=None and interpolate=True, caused by previous fix to the wrapping issue [#2526](https://github.com/psychopy/psychopy/issues/2526)
...
- further fix to Mic for experiments created under the previous version (our last fix only solved the problem for new
  Mic Components being inserted) [#2512](https://github.com/psychopy/psychopy/issues/2512)
...
- Microphone on windows failed if user didn't manually set pyo to be preferred lib. That isn't now needed [commit:700b72cd6](https://github.com/psychopy/psychopy/commit/700b72cd6)
...
- local project repeatedly asking to Create New Pavlovia project when one already exists [commit:c3f0d203f](https://github.com/psychopy/psychopy/commit/c3f0d203f)
- Fixed "No module named 'PyQt4'" on MacOS<10.10 caused by PyQt dropping support for Mac10.9 in PyQt5.9 [#2375](https://github.com/psychopy/psychopy/issues/2375)
- don't allow movie->online to use units 'from experiment settings' [commit:8cbaf8a71](https://github.com/psychopy/psychopy/commit/8cbaf8a713)
- Py3 string/byte fixes for CRS ColorCal [commit:3bf1b7e5d](https://github.com/psychopy/psychopy/commit/3bf1b7e5d4) [commit:d49f154a0](https://github.com/psychopy/psychopy/commit/d49f154a0)
...
<span style="color:red">CHANGED: Slight change to creation of *new* experiments, which will now default to</span>
...
- Builder's PsychoJS outputs were not updating their versions (pointing to the version the script was first created in, not the version currently used) [commit:789d24ee4](https://github.com/psychopy/psychopy/commit/789d24ee45aa)
- sounddevice under Python2 had a bug with being unable to copy() [commit:c1317b6b6](https://github.com/psychopy/psychopy/commit/c1317b6b6355e)
...
- New rating scale (Slider) handles color properly [#1944](https://github.com/psychopy/psychopy/issues/1944) and better handling of button drag [#1945](https://github.com/psychopy/psychopy/issues/1945)
...
- fix to MovieStim3 unloading of movies [#1917](https://github.com/psychopy/psychopy/issues/1917)
...
* Fixes event code creation for Black Box ToolKit [#1830](https://github.com/psychopy/psychopy/issues/1830)
* Removed redundant 'apply' button in preferences [#1832](https://github.com/psychopy/psychopy/issues/1832)
* Fixes problem with setting gamma with pyglet v1.3+ [#1834](https://github.com/psychopy/psychopy/issues/1834)
* Removes 'unknown color space' warning if user is using named colors [#1836](https://github.com/psychopy/psychopy/issues/1836)
* Fixes refcount error, raised when monitor centre was closed [#1838](https://github.com/psychopy/psychopy/issues/1838)
* For Py3, JSON calibration files are now loaded into monitor list [#1839](https://github.com/psychopy/psychopy/issues/1839)
* Fixes layout problem with RTL locale causing broken dialogs in the app [#1840](https://github.com/psychopy/psychopy/issues/1840)
* Anti-buzzing fix applied to sounddevice backend [#1847](https://github.com/psychopy/psychopy/issues/1847)
* Implements checks for variable name clashes between builder and conditions file  [#1852](https://github.com/psychopy/psychopy/issues/1852)
* Reduced code redundancy for _getRegionOfFrame, and can get single pixels from front buffer [#1854](https://github.com/psychopy/psychopy/issues/1854)
* Hex color space can now be specified as a window setting in Experiment Settings [#1857](https://github.com/psychopy/psychopy/issues/1857)
* Sound duration can now be specified in conditions files [#1858](https://github.com/psychopy/psychopy/issues/1858)
...
* Several fixes to ioHub in Python3 [#1770](https://github.com/psychopy/psychopy/issues/1770) [#1771](https://github.com/psychopy/psychopy/issues/1771) and [#1775](https://github.com/psychopy/psychopy/issues/1775)
...
* several errors with **PsychoJS** outputs from Builder:
    * early termination of experiments [commit:f1bd15047](https://github.com/psychopy/psychopy/commit/f1bd15047)
    * incorrect blank email field in info.php [commit:d68c36bf9](https://github.com/psychopy/psychopy/commit/d68c36bf9)
    * incorrect component name sin endRoutine [commit:e47d90a36](https://github.com/psychopy/psychopy/commit/e47d90a36)
    * incorrect default units for image stims [commit:8c32d1c9a](https://github.com/psychopy/psychopy/commit/8c32d1c9a)
* several problems with **sound**:
    * pyo not loading [#1365](https://github.com/psychopy/psychopy/issues/1365)
    * searching for 'auto' instead of 'default' device [commit:d54d14fe](https://github.com/psychopy/psychopy/commit/d54d14fe)
    * fixed duration calculation (bug in soundfile) for sounddevice [commit:e0e01ad](https://github.com/psychopy/psychopy/commit/e0e01ad)
* textbox v textstim demo wasn't working [commit:b2913c124](https://github.com/psychopy/psychopy/commit/b2913c12476)
...
FIXED:
    * Problem with renaming of Routines preventing experiment from re-loading [#1248](https://github.com/psychopy/psychopy/issues/1248)
    * Several bugs with Builder code generation since PEP8 refactoring:
        * Static Components gave error compiling script
        * some Keyboard Components (with variable "allowed keys" settings) gave error compiling script [#1245](https://github.com/psychopy/psychopy/issues/1245)
        * Mouse Component with "Save state at end of trial" gave indentation error [#1253](https://github.com/psychopy/psychopy/issues/1253)
        * Loops gave error compiling script if conditions file was a formatted string [#1253](https://github.com/psychopy/psychopy/issues/1253)

    * Standalone distributions were not including the correct `pylink 1.1.0.4` and `pyxid` packages

ADDED:
    * Keyfinder demo to Builder view [#1252](https://github.com/psychopy/psychopy/issues/1252)
    * Support for key modifiers using `event.getKeys()` [#1242](https://github.com/psychopy/psychopy/issues/1242)
...
FIXED:
    * Builder Keyboard component was treating non-response as correct answer. [#1230](https://github.com/psychopy/psychopy/issues/1230) Thanks Jarrod
    * MovieStim2 (opencv) now compatible with newer versions of opencv (v3.x) [#1223](https://github.com/psychopy/psychopy/issues/1223)
...
ADDED:
    * Movie **outputs** in gif, mp4, mov formats automatically, using moviepy [#1228](https://github.com/psychopy/psychopy/issues/1228)
...
ADDED:
    ...
    * You can now **rename a Routine** [#1136](https://github.com/psychopy/psychopy/issues/1136)
    * a Builder experiment setting to specify the version of PsychoPy to be used when running the experiment [#1137](https://github.com/psychopy/psychopy/issues/1137)
...
IMPROVED:
    ...
    * Code Components now indicate which ones actually contain code. [#1204](https://github.com/psychopy/psychopy/issues/1204)

FIXED:
    * bug with Monitor center not creating/saving monitor due to lack of SizePix [#1208](https://github.com/psychopy/psychopy/issues/1208)
    ...
    * sampling rate when using binocular mode in eyelink 1000 [#1146](https://github.com/psychopy/psychopy/issues/1146)
    * Aperture now supports infinite durations in Builder [#1122](https://github.com/psychopy/psychopy/issues/1122)
    * ColorCal II now supports newer pyserial version [#1138](https://github.com/psychopy/psychopy/issues/1138)
    * Erroneous extra data column added if experiment was aborted [#1115](https://github.com/psychopy/psychopy/issues/1115)
    * Ubuntu buglet with importing iohub devices caused by outdated psutils [#1172](https://github.com/psychopy/psychopy/issues/1172)
...
* FIXED:
  ...
  * Setting gamma on OSX 10.11 wasn't working (Apple moved the lib to a new location). [#1089](https://github.com/psychopy/psychopy/issues/1089)
...
* FIXED:
  ...
  * window viewScale and viewPos combine correctly; viewScale handles negative values, mirror-image flips the window correctly (except for Text) [#1011](https://github.com/psychopy/psychopy/issues/1011)
  * fixed memory leak in sounds on 64bit Mac installation (error in pyo)
  * MovieStim3 was interacting badly with ShapeStim [#981](https://github.com/psychopy/psychopy/issues/981)
  * MovieStim3 was failing if no audio stream was present in the file [#984](https://github.com/psychopy/psychopy/issues/984)
  * PsychoPy app now gives a warning message if it can't start due to permissions error [#1055](https://github.com/psychopy/psychopy/issues/1055)
...
* <span style="color:red">CHANGED: remove support for google's speech to text (the new google API is for chrome / chromium developers only)</span>
* <span style="color:red">CHANGED: deprecate psychopy.web.upload(); use the requests package instead: requests.post()</span>
...
* ADDED: Coder view can now be set to read-only mode to prevent subjects accidentally altering study [#945](https://github.com/psychopy/psychopy/issues/945)
* ADDED: TextStim now has property `boundingBox` telling you the maximum area of the letters (defined by the font, not by the actual rendered letters) [commit:35c168f1](https://github.com/psychopy/psychopy/commit/35c168f1)
* ADDED: Aperture can now be created using images (anything that worked with ImageStim) [#923](https://github.com/psychopy/psychopy/issues/923) and can also be inverted so that opaque becomes transparent and vice versa [#922](https://github.com/psychopy/psychopy/issues/922) Thanks Thomas Emerling for both
* ADDED: New visual stimulus EnvelopeGrating for contrast-modulated gratings. Thanks Andrew Schofield
* ADDED: option to set mouse_exclusive mode (mouse locked to the window boundary and invisible) Thanks Suddha Sourav [#898](https://github.com/psychopy/psychopy/issues/898)
...
* FIXED: Condition file in Builder no longer abbreviated. Thanks Mike [#913](https://github.com/psychopy/psychopy/issues/913)
...
Released: Aug 2015
    ...
    - FIXED: TrialHandler wasn't saving extraInfo (was overwritten during trials) [#815](https://github.com/psychopy/psychopy/issues/815)
    - FIXED: don't have pickle file re-saving itself when it comes back from pickling [#833](https://github.com/psychopy/psychopy/issues/833)
    - FIXED: Mouse Component could crash data saving if no response was made [#839](https://github.com/psychopy/psychopy/issues/839)
    - FIXED: memory leaks in MovieStim2 (opencv backend) [#838](https://github.com/psychopy/psychopy/issues/838) and [#919](https://github.com/psychopy/psychopy/issues/919)
    - FIXED: checked that window positions are integers [#854](https://github.com/psychopy/psychopy/issues/854)
    - FIXED: OSX "10.10" incorrectly looked older than "10.9" [#866](https://github.com/psychopy/psychopy/issues/866)
    - FIXED: RatingScale would show "False" for scale description in some cases [#870](https://github.com/psychopy/psychopy/issues/870)
    - FIXED: problem with microphone saving files that end with w, a or v [#875](https://github.com/psychopy/psychopy/issues/875)
    - FIXED: MonitorCenter failing to create new monitor [#887](https://github.com/psychopy/psychopy/issues/887)
    - FIXED: universal line endings in csv outputs files [#889](https://github.com/psychopy/psychopy/issues/889)
    - FIXED: unicode in conditions files [#892](https://github.com/psychopy/psychopy/issues/892)
    - FIXED: `iohub` not detecting Linux mouse events [#894](https://github.com/psychopy/psychopy/issues/894)
    - FIXED: if output file is set to be `stdout` this should then be closed [#902](https://github.com/psychopy/psychopy/issues/902)
    - FIXED: don't abbreviate the path name of conditions files [#913](https://github.com/psychopy/psychopy/issues/913)
    - FIXED: minor error in logging for `rush()` under win32 [#914](https://github.com/psychopy/psychopy/issues/914)
    - FIXED: unicode issues in user preferences panel [#930](https://github.com/psychopy/psychopy/issues/930) [#932](https://github.com/psychopy/psychopy/issues/932)
    - FIXED: MonitorCenter won't lock you out if given an invalid screen number [#937](https://github.com/psychopy/psychopy/issues/937)
...
* FIXED: better timing for non-slip routines that follow dynamic routines (Jeremy) [#822](https://github.com/psychopy/psychopy/issues/822)
...
* <span style="color:red">CHANGED: for text data outputs that give delim='\t' the file extension '.tsv' is added instead of '.dlm' (Richard Höchenberger)</span>
...
* <span style="color:red">CHANGED: 'pandas' is now a strict requirement for the 'psychopy.data' module</span>
...
* <span style="color:red">CHANGED: MovieStim was right-left flipping movies and this has been corrected. If you had been working around that by setting flipVertical=True then you'll need to undo that correction</span>
...
* ADDED: support for additional hardware:
    ...
    * <span style="color:red">CHANGED: added basic support for CRS Bits# in psychopy.hardware.crs. New way to interface with Bits++ as well, using a class rather than a Window argument. See demo in demos>hardware</span>
...
* IMPROVED: logging
    ...
    * <span style="color:red">CHANGED: 'log=None' and 'autoLog=None' inherits from parents, with 'visual.Window' at the top of the hierarchy. None is now default for all stimuli and setter methods.</span>
...
* IMPROVED: psychopy.ioHub
    ...
    * <span style="color:red">CHANGED: Keyboard device and events are more user-friendly.</span>
...
* <span style="color:red">CHANGED: Sound object now checks if the sound is a note name before checking for file names (only affects cases where the file name was something like A.wav)</span>
...
* <span style="color:red">CHANGED: Size of 'square' or 'triangle' apertures used to represent the radius of the circle on which their vertices</span>
...
* <span style="color:red">CHANGED: Builder: remove option: choiceLabelsAboveLine; change lowAnchorText, highAnchorText -> labels</span>
* <span style="color:red">CHANGED: skipping a rating now adds None as the final element in the history</span>
* <span style="color:red">CHANGED: the default minTime is shorter, now 0.4s</span>
* <span style="color:red">CHANGED: more info in the log when creating a rating scale object</span>
* <span style="color:red">CHANGED: removed showAnchors: now use labels=None (instead of showAnchors=False)</span>
* <span style="color:red">CHANGED: removed lowAnchorText & highAnchorText: now use labels=['leftAnchor', 'rightAnchor'] or with optional 3rd midpoint label</span>
* <span style="color:red">CHANGED: renamed several parameters: stretchHoriz -> stretch, textSizeFactor -> textSize, ticksAboveLine -> tickHeight, displaySizeFactor -> size, markerStyle -> marker, customMarker -> marker</span>
* <span style="color:red">CHANGED: removed showScale: now use scale=None (instead of showScale=False)</span>
* <span style="color:red">CHANGED: removed allowSkip: now use skipKeys=None (instead of allowSkip=False)</span>
* <span style="color:red">CHANGED: removed escapeKeys; no longer supported but it's easy to implement (as now done in the coder demo)</span>
...
* <span style="color:red">CHANGED: data curve fitting functions are now using scipy.optimise.curve_fit and should hopefully be more robust to local minima(?)</span>
...
* <span style="color:red">CHANGED: microphone default file names include milliseconds (to avoid two files with the same name)</span>
...
* <span style="color:red">CHANGED: RatingScale.getRating() no longer returns False prior to an accepted rating (now returns the currently selected value)</span>
...
* <span style="color:red">CHANGED: PsychoPy Standalone is now being built using python 2.7.3 (rather than 2.6). Under OSX psignifit has been removed from this distribution, as have the libraries to create .mov files using Window.saveMovieFrames(). If you need those features then install the 1.75 Standalone and then update to 1.76 using the auto-update system.</span>
...
* <span style="color:red">CHANGED: various changes to RatingScale (thanks Henrik Singman):</span>
   * <span style="color:red">CHANGED: choices are now displayed at the tick marks by default (instead of above the line). To restore the old behavior set labels=False. This does not affect experiments created in older versions of the builder.</span>
...
* <span style="color:red">CHANGED: exp.name is no longer available from Builder scripts (can use exp.getExpName() instead)</span>
...
* <span style="color:red">CHANGED: New Builder experiments will, by default, save a single csv file, a single psydat file and a single log file. Was previously also saving an Excel file (with one sheet per loop) and many psydat files (one per loop). Psydat files can still be used to re-output any format of data file.</span>
...
* <span style="color:red">CHANGED: in Builder the default dotstim has signal dots='same' (once a signal dot, always a signal dot). Only affects new experiments.</span>
...
* <span style="color:red">CHANGED: removed python 2.4 version of sha1 digest from :class:'~psychopy.info.RunTimeInfo'</span>
* <span style="color:red">CHANGED: removed any need for PyOpenGL (pyglet.gl now used throughout even for pygame windows)</span>
...
* <span style="color:red">CHANGED: Builder scripts now silently convert division from integers to float where necessary. That means 1/3=0.333 whereas previously 1/3=0. This is done simply by adding the line 'from __future__ import division' at the top of the script, which people using Coder might want to think about too.</span>
...
* <span style="color:red">CHANGED: psychopy.log has moved to psychopy.logging (Alex Holcombe's suggestion). You'll now get a deprecation warning for using psychopy.log but it will still work (for the foreseeable future)</span>
...
* <span style="color:red">CHANGED: gui.Dlg and gui.dlgFromDict can now take a set of choices and will convert to a choice control if this is used (thanks Manuel Ebert)</span>
...
* <span style="color:red">CHANGED: the number of stimulus-resized and frames-dropped warnings is now limited to 5 (could become a preference setting?)</span>
...
* <span style="color:red">CHANGED: Depth testing is now disabled. It was already being recommended that depth was controlled purely by drawing order (not depth settings) but this is now the *only* way to do that</span>
* <span style="color:red">CHANGED: The Builder representation of the Components onset/offset is now based on 'estimatedStart/Stop' where a value has been given. NB this does not affect the actual onset/offset of Components merely its representation on the timeline.</span>
...
* <span style="color:red">CHANGED use of allowedKeys in Keyboard Component. You used to be able to type 'ynq' to get those keys, but this was confusing when you then needed ''space'' or ''left'' etc. Now you must type 'y','n','q', which makes it more obvious how to include 'space','left','right'...</span>
* <span style="color:red">CHANGED dot algorithm in DotStim. Previously the signalDots=same/different was using the opposite to Scase et al's terminology, now they match. Also the default method for noiseDots was 'position' and this has been changed to 'direction'. The documentation explaining the algorithms has been clarified. (see :ref:'dotscomponent')</span>
* <span style="color:red">CHANGED 'MovieStim.playing' property to be called 'MovieStim.status' (in keeping with other stimuli)</span>
* <span style="color:red">CHANGED names:</span>
...
* <span style="color:red">CHANGED numpy imports in Builder scripts:</span>
...
* <span style="color:red">CHANGED Builder use of $. $ can now appear anywhere in the field (previously only the start). To display a '$' character now requires '\$' in a text field (to prevent interpretation of normal text as being code).</span>
...
* <span style="color:red">CHANGED Builder keyboard components now have the option to discard previous keys (on by default)</span>
* <span style="color:red">CHANGED RatingScale:</span>

  - ADDED: argument to set lineColor independently (thanks Jeff Bye)
  - <span style="color:red">CHANGED default marker is triangle (affects windows only)</span>
...
* <span style="color:red">CHANGED RatingScale (Jeremy Gray):</span>
    ...
    - <span style="color:red">CHANGED RatingScale internals; renamed escapeKeys as skipKeys; subject now uses 'tab' to skip (Jeremy Gray)</span>
...
* <span style="color:red">CHANGED optimisation routine from fmin_powell to fmin_bfgs. It seems more robust to starting params.</span>
...
* <span style="color:red">CHANGED default values for Builder experiment settings (minor)</span>
* <span style="color:red">CHANGED ShapeStim default fillColor to None (from (0,0,0))</span>
* FIXED DotStim now supports a 2-element fieldSize (x,y) again
* <span style="color:red">CHANGED phase of RadialStim to be 'sin' instead of 'cosine' at phase=0</span>
...
* <span style="color:red">CHANGED Builder demos are now back in the distributed package. Use >Demos>Unpack... to put them in a folder you have access to and you can then run them from the demos menu</span>
...
* <span style="color:red">CHANGED: TextStim orientation now goes the other way, for consistency with other stimuli (thanks Manuel Spitschan for noticing)**</span>
...
* <span style="color:red">CHANGED: builder hides mouse now during fullscreen experiments (should make this a pref or setting though?)</span>
...
* <span style="color:red">CHANGED: data output now uses std with N-1 normalisation rather than (scipy default) N</span>
...
* <span style="color:red">CHANGED: mouse icon is now hidden for full-screen Builder experiments</span>
...
* <span style="color:red">CHANGED: for builder experiments the trial list for a loop is now imported from the file on every run, rather than just when the file is initially chosen</span>
* <span style="color:red">CHANGED: data for TrialHandler are now stored as masked arrays where possible. This means that trials with no response can be more easily ignored by analysis</span>
...
* <span style="color:red">CHANGED: RunTimeInfo is now in psychopy.info not psychopy.data</span>
* <span style="color:red">CHANGED: PatchStim for image files now defaults to showing the image at native size in pixels (making SimpleImageStim is less useful?)</span>
* <span style="color:red">CHANGED: access to the parameters of TrialList in the Builder now (by default) uses a more cluttered namespace for variables. e.g. if your TrialList file has heading rgb, then your components can access that with '$rgb' rather than '$thisTrial.rgb'. This behaviour can be turned off with the new Builder preference 'allowClutteredNamespace'.</span>
...
* <span style="color:red">CHANGED: Builder demos now need to be fetched by the user - menu item opens a browser (this is slightly more effort, but means the demos aren't stored within the app which is good)</span>
* <span style="color:red">CHANGED: loops/routines now get inserted to Flow by clicking the mouse where you want them :-)</span>
...
* <span style="color:red">CHANGED: movie file used in movie demo (the chimp had unknown copyright)</span>
...
* <span style="color:red">CHANGED: color handling substantially. Now supply color and colorSpace arguments and use setColor rather than setRGB etc. Previous methods still work but give deprecation warning.</span>
...
* <span style="color:red">CHANGED: console (stdout) default logging level to WARNING. More messages will appear here than before</span>
...
* <span style="color:red">CHANGED: stimuli using textures now automatically clean these up, so no need for users to call .clearTextures()</span>
...
* <span style="color:red">CHANGED ext.rush() is no longer run by default on creation of a window. It seems to be causing more probs and providing little enhancement.</span>
...
* <span style="color:red">CHANGED builder component variables so that the user inputs are interpreted as literal text unless preceded by $, in which case they are treated as variables/python code</span>
* <span style="color:red">CHANGED builder handling of keyboard 'allowedKeys' parameter. Instead of '['1','2','q']' you can now simply use '12q' to indicate those three keys. If you want a key like ''right'' and ''left'' you now have to use '$['right','left']'</span>
...
* <span style="color:red">CHANGED: builder components now have a 'startTime' and 'duration' rather than 'times'</span>
...
* <span style="color:red">CHANGED: psychopy.filters.makeMask() now returns a mask with values -1:1, not 0:1 (as expected by stimulus masks)</span>
...
* <span style="color:red">CHANGED: gamma handling to handle buggy graphics drivers on certain cards - see note below</span>
* <span style="color:red">CHANGED: coord systems for mouse events - both winTypes now provide mouse coords in the same units as the Window</span>
...
* <span style="color:red">CHANGED (Builder) creating a new file in Builder (by any means) automatically adds a 'trial' Routine</span>
...
* <span style="color:red">CHANGED license to GPL (more restrictive, preventing proprietary use)</span>
* <span style="color:red">CHANGED gui dialogs are centered on screen rather than wx default position</span>
...
* <span style="color:red">CHANGED interpreters in all .py scripts to be the same (#!/usr/bin/env python). Use PATH env variable to choose non-default python version for your Python scripts</span>
* <span style="color:red">CHANGED pyglet textures to use numpy->ctypes rather than numpy->string</span>
...
* <span style="color:red">CHANGED IDE on win32 to run scripts as processes rather than imports (gives better error messages)</span>
* ADDED mipmap support for textures (better antialiasing for down-scaling)
* <span style="color:red">CHANGED win32 standalone to include the whole raw python rather than using py2exe</span>
...
* <span style="color:red">CHANGED image loading code to check whether the image is a file, rather than using try..except</span>
...
* <span style="color:red">CHANGED: frame time recording to be *off* by default (for plotting, for Window.fps() and for warnings). To turn it on use Window.setRecordFrameIntervals(True), preferably after first few frames have elapsed</span>
...
* <span style="color:red">CHANGED pyglet key checking now returns '1' as the key irrespective of numpad or otherwise (used to return '1' or 'NUM_1')</span>
...
* <span style="color:red">CHANGED default sound handler to be pygame again. Although pyglet looked promising for this</span>
...
PsychoPy 0.95.4:
~~~~~~~~~~~~~~~~~~~~~~
* <span style="color:red">CHANGED PsychoPy options (IDE and monitors) now stored the following, rather than with the app. (monitor calib files will be moved here if possible)</span>
...
* <span style="color:red">CHANGED input range for numpy array textures to -1:1</span>
...
* <span style="color:red">CHANGED dlgFromDict to return None on cancel rather than 0</span>
* <span style="color:red">CHANGED the description of sin textures so that the centre of the patch had the color of dkl or rgb rather</span>
...
* <span style="color:red">CHANGED waitKeys to return a list of keys (usually of length one) so that it's compatible with getKeys</span>
...
* <span style="color:red">CHANGED visual.Window so that the monitor argument prefers to receive a Monitor object (rather than just a dictionary) or just the name of one. MonitorCenter makes it so easy to create these now that they should be the default.</span>
* <span style="color:red">CHANGED Photometer initialisation behaviour - used to raise an error on a fail but now sets an internal attribute .OK to False rather than True</span>
...
PsychoPy 0.64
~~~~~~~~~~~~~~~~~~~~~~
* <span style="color:red">CHANGED monitor key dkl_rgb_matrix to dkl_rgb (also for lms)</span>
...
* <span style="color:red">CHANGED TextStim to take the font as a name rather than font number</span>
* ADDED alignment to text stimuli (alignVert, alignHoriz)
* <span style="color:red">CHANGED waitKeys to implicitly clear keys from the event queue so that it only finds the first keypress after its called. As result it now returns a single character rather than list of them</span>
* <span style="color:red">CHANGED visual.Window so that it no longer overrides monitor settings if arguments are specified. Easy now to create a monitor in the monitors GUI and use that instead</span>
